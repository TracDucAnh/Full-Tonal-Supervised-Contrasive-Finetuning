# This code is used to supervised contrasive finetune HuBERT model to group lexical tones in representation space.
# Visualize the distribution of lexical tones after every epoch.
# Save checkpoint, graphs in HuBERT_finetuned/
"""
Supervised Contrastive Learning for HuBERT - Vietnamese Lexical Tones
- Finetune HuBERT to group same tones close together in representation space
- Visualize t-SNE after each epoch
- Save checkpoints and visualizations to HuBERT_finetuned/
...
# ============================================================================
# HuBERT Contrastive Model
# ============================================================================
class HubertContrastiveClassifier(nn.Module):
    """
    HuBERT model with Contrastive Learning
    - Encoder: HuBERT backbone
    - Projection head: For contrastive learning
    - Classification head: For supervised classification
    """

    def __init__(self, model_name='facebook/hubert-base-ls960', num_classes=6,
                 projection_dim=128, freeze_feature_extractor=False):
        super(HubertContrastiveClassifier, self).__init__()
        ...
        print("HuBERT Contrastive model initialized")
...
def plot_tsne(features, labels, epoch, save_path, title_suffix=""):
    ...
    title = f'Vietnamese Tone Distribution - t-SNE Visualization (HuBERT)\nEpoch {epoch} {title_suffix}'
...
def main():
    ...
    print("=" * 80)
    print("SUPERVISED CONTRASTIVE LEARNING FOR HUBERT")
    ...
    model = HubertContrastiveClassifier(
    ...
    optimizer = optim.AdamW([
        {'params': model.hubert.parameters(), 'lr': LEARNING_RATE * 0.1},
    ...
    for epoch in range(1, NUM_EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            # Save model state
            model.hubert.save_pretrained(checkpoint_path)
    ...
    title = 'Confusion Matrix - Supervised Contrastive Learning (HuBERT)'
    if USE_WEIGHTED_LOSS:
